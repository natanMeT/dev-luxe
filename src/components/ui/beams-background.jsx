...
export function BeamsBackground({ className, children, intensity = 'strong' }) {
  ...
  return (
    <div className={cn('relative min-h-screen w-full overflow-hidden', className)} style={{ background: '#040812' }}>
      ...
      <motion.div
        ...
        style={{ backdropFilter: 'blur(50px)', background: 'rgba(4,8,18,0.05)' }}
      />
